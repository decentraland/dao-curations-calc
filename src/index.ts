...
async function main() {
  ...
  while (true) {
    const res = await fetch(
      'https://api.thegraph.com/subgraphs/name/decentraland/collections-matic-mainnet',
      {
        ...
        body: `{\"query\":\"{\\n  curations(orderBy: timestamp, orderDirection: asc, first: 1000, where: { timestamp_gte: ${timestamp} }, block: { number: 27820000 }) {\\n    curator {\\n      id\\n    }\\n    collection {\\n      id\\n      itemsCount\\n      name\\n    }\\n    isApproved\\n    timestamp\\n    txHash\\n  }\\n}\\n\",\"variables\":null}`,
        method: 'POST'
      }
    )
  ...
  const lastTotal : { [curator: string]: number } = {
    ...
    '0x8938d1f65abe7750b0777206ee26c974a6721194': 660,
    '0x91e222ed7598efbcfe7190481f2fd14897e168c8': 388,
    '0x399a44f5821b1f859bc236e14367c4f7c36933fb': 140,
    '0x967fb0c36e4f5288f30fb05f8b2a4d7b77eaca4b': 94,
    '0x5e382071464a6f9ea29708a045983dc265b0d86d': 254,
    '0xc8ad6322821b51da766a4b2a82b39fb72b53d276': 130,
    '0xa8c7d5818a255a1856b31177e5c96e1d61c83991': 212,
    '0x336685bb3a96e13b77e909d7c52e8afcff1e859e': 166,
    '0x41eb5f82af60873b3c14fedb898a1712f5c35366': 123,
    '0x470c33abd57166940095d59bd8dd573cbae556c3': 52,
    '0x1dec5f50cb1467f505bb3ddfd408805114406b10': 47,
    '0x805797df0c0d7d70e14230b72e30171d730da55e': 632
  };

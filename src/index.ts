...
async function main() {
  ...
  while (true) {
    const res = await fetch(
      'https://api.thegraph.com/subgraphs/name/decentraland/collections-matic-mainnet',
      {
        ...
        body: `{\"query\":\"{\\n  curations(orderBy: timestamp, orderDirection: asc, first: 1000, where: { timestamp_gte: ${timestamp} }, block: { number: 26617168 }) {\\n    curator {\\n      id\\n    }\\n    collection {\\n      id\\n      itemsCount\\n      name\\n    }\\n    isApproved\\n    timestamp\\n    txHash\\n  }\\n}\\n\",\"variables\":null}`,
        method: 'POST'
      }
    )
  ...
  const lastTotal : { [curator: string]: number } = {
    '0x5d7846007c1dd6dca25d16ce2f71ec13bcdcf6f0': 218,
    '0x716954738e57686a08902d9dd586e813490fee23': 130,
    '0x7a3891acf4f3b810992c4c6388f2e37357d7d3ab': 373,
    '0x82d54417fc69681dc74a6c0c68c6dbad5a2857b9': 446,
    '0x8938d1f65abe7750b0777206ee26c974a6721194': 599,
    '0x91e222ed7598efbcfe7190481f2fd14897e168c8': 386,
    '0x399a44f5821b1f859bc236e14367c4f7c36933fb': 140,
    '0x967fb0c36e4f5288f30fb05f8b2a4d7b77eaca4b': 94,
    '0x5e382071464a6f9ea29708a045983dc265b0d86d': 142,
    '0xc8ad6322821b51da766a4b2a82b39fb72b53d276': 92,
    '0xa8c7d5818a255a1856b31177e5c96e1d61c83991': 30,
    '0x336685bb3a96e13b77e909d7c52e8afcff1e859e': 94,
    '0x41eb5f82af60873b3c14fedb898a1712f5c35366': 42,
    '0x470c33abd57166940095d59bd8dd573cbae556c3': 49,
    '0x1dec5f50cb1467f505bb3ddfd408805114406b10': 14,
    '0x805797df0c0d7d70e14230b72e30171d730da55e': 265,
  };
